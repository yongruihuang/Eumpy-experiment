...
"""
  This is an example for processing enum fusion algorithm in MAHNOB_HCI dataset using the function in ../process_enum/enum_tool script
...
if __name__ == '__main__':
    ...
    for subject_id in range(1, 10):
        ...
        for validation_trial_id in range(1, 21):
            ...
            enum_model = enum_tool.Enum_model(preprocessed = False)
